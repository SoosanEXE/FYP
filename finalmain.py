...
model = joblib.load('AnomalyClassifier/NSLAnoClf.pkl')
df = pd.read_parquet("DataPreprocess/KDDpreprocessed.parquet")
df_mul = pd.read_parquet("KDDpreprocessed1.parquet")
...
model1 = joblib.load('AnomalyClassifier/UNSWAnoClf.pkl')
df1 = pd.read_parquet("DataPreprocess/UNSWpreprocessed.parquet")
df1_mul = pd.read_parquet("UNSWpreprocessed1.parquet")
...
# feature_names = loaded_model.feature_names_in_
# print("Model features:", feature_names)
model3 = joblib.load('AnomalyClassifier/NSLAnoClf1.pkl')
...
print(".................................................................")
model4 = joblib.load('AnomalyClassifier/UNSWAnoClf1.pkl')
